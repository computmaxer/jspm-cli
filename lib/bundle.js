...
var oldPaths = {};
function setLocalPaths(jspmPackagesPath) {
  // set local
  var jspmPackages = path.relative(config.dir, jspmPackagesPath || config.jspmPackages);
...
exports.bundle = function(moduleExpression, fileName, inject, packagesPath) {
